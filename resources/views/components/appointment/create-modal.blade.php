    ...
    <div class="relative w-full max-w-2xl max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="mb-2 md:mb-4">
                    ...
                    >
                        <template x-for="openDay in openDays">
                            ...
                            >
                                <div
                                    class="bg-fuchsia-100 hover:bg-fuchsia-200 px-2 py-1.5 text-center rounded-md border-2 shadow-md"
            ...
            <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                <button
                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center disabled:bg-blue-400 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
