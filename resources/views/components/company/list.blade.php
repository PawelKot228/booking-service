                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-center mt-2">
                            ...
                            <p class="text-sm font-bold text-gray-900 dark:text-white"
                                x-text="company.reviews.avg_rating"
                            ></p>
                        </div>

                        <a x-bind:href="company.reviews.url" class="text-sm font-medium text-gray-900 underline hover:no-underline dark:text-white">
                            <span x-text="company.reviews.count"></span>
                            {{ __('reviews') }}
                        </a>
